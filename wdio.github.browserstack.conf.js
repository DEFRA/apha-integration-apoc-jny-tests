...
export const config = {
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `apha-integration-apoc-jny-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `apha-integration-apoc-jny-tests-${process.env.ENVIRONMENT}`
        },
